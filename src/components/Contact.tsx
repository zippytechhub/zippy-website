            ...
            {contactMethods.map((method, index) => {
              ...
              return (
                <ScrollAnimation key={index} delay={index * 200} variantType='slideLeft'>
                  <div className='flex items-start p-6 space-x-4 transition-colors duration-200 bg-gray-50 rounded-xl hover:bg-gray-100'>
          ...
          <div className='mt-16 text-center'>
            <div className='p-8 bg-gray-100 rounded-xl'>
              ...
              <p className='max-w-4xl mx-auto text-lg leading-relaxed text-gray-600'>
                We are dedicated to ensuring you have the best possible experience. If you have any
                questions, concerns, or issues, we are here to assist you with prompt and
