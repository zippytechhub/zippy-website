import { CreditCard, GraduationCap, Smartphone, Tv, Wifi, Zap } from 'lucide-react'
        ...
        <div className='grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3'>
          {services.map((service, index) => {
            ...
            return (
              <div
                key={index}
                className='p-8 transition-all duration-300 transform bg-white border border-gray-100 shadow-lg rounded-xl hover:shadow-xl hover:-translate-y-2'
              >
